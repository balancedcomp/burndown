...
#  let(:valid_attributes) { { "date" => "2014-05-24" } }
#
...
#      expect(assigns(:iterations)).to eq([iteration])
#    end
#  end
#
...
#      expect(assigns(:iteration)).to eq(iteration)
#    end
#  end
#
#  describe "GET new" do
...
#      expect(assigns(:iteration)).to be_a_new(Iteration)
#    end
#  end
#
...
#        post :create, {:iteration => valid_attributes}, valid_session
#        expect(assigns(:iteration)).to be_a(Iteration)
#        expect(assigns(:iteration)).to be_persisted
#      end
#
#      it "redirects to the created iteration" do
#        post :create, {:iteration => valid_attributes}, valid_session
#        expect(response).to redirect_to(Iteration.last)
#      end
#    end
#
...
#        allow_any_instance_of(Iteration).to receive(:save).and_return(false)
#        post :create, {:iteration => { "date" => "invalid value" }}, valid_session
#        expect(assigns(:iteration)).to be_a_new(Iteration)
#      end
#
...
#        expect_any_instance_of(Iteration).to receive(:update).with({ "date" => "2014-05-24" })
#        put :update, {:id => iteration.to_param, :iteration => { "date" => "2014-05-24" }}, valid_session
#      end
#
#      it "assigns the requested iteration as @iteration" do
#        iteration = Iteration.create! valid_attributes
...
#        iteration = Iteration.create! valid_attributes
#        put :update, {:id => iteration.to_param, :iteration => valid_attributes}, valid_session
#        expect(response).to redirect_to(iteration)
#      end
#    end
#
#    describe "with invalid params" do
...
#        iteration = Iteration.create! valid_attributes
#        # Trigger the behavior that occurs when invalid params are submitted
#        allow_any_instance_of(Iteration).to receive(:update).and_return(false)
#        put :update, {:id => iteration.to_param, :iteration => { "date" => "invalid value" }}, valid_session
#        expect(assigns(:iteration)).to eq(iteration)
#      end
#
...
#      iteration = Iteration.create! valid_attributes
#      delete :destroy, {:id => iteration.to_param}, valid_session
#      expect(response).to redirect_to(iterations_url)
#    end
#  end
#
#end
