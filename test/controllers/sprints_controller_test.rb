...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { start_date: @sprint.start_date, title: @sprint.title, total_points: @sprint.total_points }
    end
  ...
  test "should update sprint" do
    patch :update, id: @sprint, sprint: { start_date: @sprint.start_date, title: @sprint.title, total_points: @sprint.total_points }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
